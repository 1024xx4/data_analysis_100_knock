...
文章を数値化し、Computer が理解できる状態にしてあげつ時に必要な技術。

- アンケート
- 口コミ
- SNS への投稿

など現在において文章による Data には多くの情報が眠っている。  
文章情報の取り出しやまとめ作業を人間が行なうと
- １名では Data 量が膨大となる。
- 複数人で作業すると各個人の主観により Data の粒度にバラつきが発生

などの問題が発生する。自然言語処理を行なうことで100%とはいかないがかなりの課題を Clear できる。

## アンケート Data の現場
- Comment などは欠損値が多く。ほぼ、欠損値なここともある。
- 欠損値の確認が必須となる。
- 想像以上に泥臭い作業が必要となる Case が多い。KK

### 理由
５段階評価などは簡単なのでやってくれるが、Comment は面倒で記入されないことが多い。

## 形態素解析
単語に分割する技術のこと。

## 類似文章の検索
文章の特徴を表現し、その表現をもとに類似文章を特定する技術。  
例えば、類似性の高い文章のみ抽出して、満足度や顧客自体の深堀分析など、分析の幅を大きく広げることができる。
